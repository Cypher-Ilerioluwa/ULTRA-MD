...
const defaultOwner = '2349121881343';


// Check for the OWNERS environment variable; if not found, use the default
const ownervb = process.env.OWNERS || process.env.OWNER_NUMBER || '2349121881343';  // put your number here
...
//
global.botname = process.env.BOTNAME || 'ÀKÀNDÉ-MIDÉ-BOT🤖🌹🍀';
global.pairingNumber = process.env.BOT_NUMBER || '2349121881343';  // put your number here
global.SESSION_ID = process.env.SESSION_ID || 'HcpzhaIC#iPcSi5O-PCZZbOAqstyqlv9FVbQPsLJ86Bt2Xk6CT5k';  // put your session id here
